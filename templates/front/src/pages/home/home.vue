...
<!-- 商品推荐 -->
<div id="animate_recommendertongtushu" class="recommend animate__animated" :style='{"padding":"60px 0 60px","margin":"40px auto 20px","borderColor":"#ddd","background":"#f1f1f1","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"solid","order":"2"}'>
    ...
    <div class="title" :style='{"width":"76%","padding":"45px 0 0","margin":"0px auto","textAlign":"left","background":"url() no-repeat left top / auto 42px","height":"120px"}'>
		<span :style='{"padding":"0","fontSize":"32px","color":"#000","fontWeight":"600","display":"block"}'>儿童图书推荐</span>
	</div>
		...
		<div v-if="ertongtushuRecommend.length" class="list list16 index-pv1" :style='{"padding":"0 12%","margin":"20px 0 0","color":"#999","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"space-between","height":"auto"}'>
		  <div v-for="item,index in ertongtushuRecommend" :key="index"  @click="toDetail('ertongtushuDetail', item)" class="list-item animation-box">
		    ...
		    <div :style='{"width":"100%","padding":"0","overflow":"hidden","display":"flex","height":"auto"}' class="item-info">
		      <div :style='{"width":"100%","padding":"0 0 10px","flexWrap":"wrap","display":"flex"}'>
				<div class="title">{{item.tushumingcheng}}</div>
				<div class="title">{{item.tushufenlei}}</div>
				<div class="title">作者:{{item.zuozhe}}</div>
		      ...
		      <div class="desc" v-html="item.tushuxiangqing"></div>
		    </div>
		  </div>
		</div>
	
	<div @click="moreBtn('ertongtushu')" :style='{"border":"0px solid #fff","cursor":"pointer","padding":"0 20px 0 0","margin":"90px -12px 0 0","textAlign":"right","display":"block","right":"12%","top":"0","background":"url(http://codegen.caihongy.cn/20231010/b345185c76ac4a77bf4cd6f6171a72ed.png) no-repeat center top / 100% 100%","width":"240px","lineHeight":"73px","position":"absolute","height":"80px"}'>
			...
			<div class="content">
		      ...
		      <div class="info">
		        ...
		        <div :style='{"padding":"0","margin":"0 10px 0 0","display":"inline-block"}'>
		          <span class="icon iconfont icon-chakan9" :style='{"margin":"0 2px 0 0","lineHeight":"1.5","fontSize":"inherit","color":"#f89df9"}'></span>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendertongtushu',css:'animate__'},
      ...
      preHttp(str) {
		...
		getList() {
			let autoSortUrl = "";
			let data = {}
          autoSortUrl = "ertongtushu/autoSort";
          if(localStorage.getItem('frontToken')) {
              autoSortUrl = "ertongtushu/autoSort2";
          }
			data = {
				page: 1,
				limit: 8,
			...
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.ertongtushuRecommend = res.data.data.list;
